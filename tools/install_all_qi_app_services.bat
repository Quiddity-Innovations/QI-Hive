...
echo. & echo === QI_PersonalSong === & call "C:\PersonalSong\install_service.bat"
echo. & echo === QI_M2V === & call "C:\M2V\install_service.bat"
echo. & echo === QI_M2VTunnel === & call "C:\M2V\install_tunnel.bat"
echo. & echo === TubeScout (service + tunnel, existing script) === & call "C:\TUBESCOUT\install_service_admin.bat"
