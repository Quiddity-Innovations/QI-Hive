...
STATUS_SRC  = r"C:\APPS\CLAUDE\status.json"
...
s['projects']['Claude_Manager']['notes'] = "Superseded by QI Hive (C:\\QIH). Old code preserved at C:\\APPS\\CLAUDE until NSSM migration confirmed."
s['projects']['Claude_Manager']['status'] = "migrating"

s['infrastructure']['dashboard']['note'] = "QI Hive Dashboard v3.0. New Hive page wired to QI Brain. Code at C:\\QIH\\hive\\Dashboard\\server.py. Still running from C:\\APPS\\CLAUDE until admin runs update_services.bat."
...
s['session_log'].append({
    ...
    "doc": "TBD",
    "summary": "QI Hive created. C:\\QIH scaffolded. 7 hive agents + agent_growth_log table added to QI Brain DB. 4 growth loop API endpoints added. Dashboard rebranded v3.0 with /hive page + QI Brain client. health_check.py NSSM names fixed. Claude Manager migrated to C:\\QIH\\hive. GitHub: Quiddity-Innovations/QI-Hive. QI registry + service registry updated. Projects folder strategy agreed: C:\\APPS\\QIP for projects, C:\\QIB for business (future)."
})
...
s['pending_actions'] = [
    ...
    "Future: migrate projects to C:\\APPS\\QIP one by one (Maia first)",
    "Future: rename C:\\APPS\\QI to C:\\QIB after all projects moved to C:\\APPS\\QIP",
]
