...
## Entry points
`_make_cheatsheet.py`, `_make_summary.py`, `engine_py.py`, `fetch_eu.py`, `install_service.bat`, `install_tunnel.bat`, `live_sources.py`, `lottery_general.py`, `mcp_server.py`, `restart_service.bat`, `run.bat`, `server.py`, `tunnel.bat`, `tunnel_url.bat`, `uninstall_service.bat`, `uninstall_tunnel.bat`
