...
_Generated 2026-09-17 02:35:36_

## Registry facts
- Path: `C:\APPS\NAYA\filehq`
- Status: merged_into_naya
- Ports: api:8000
...
## Entry points
`__init__.py`, `categorizer.py`, `config.py`, `database.py`, `dedup.py`, `executor.py`, `hasher.py`, `main.py`, `maintenance.py`, `planner.py`, `run.py`, `scanner.py`, `structure.py`, `undo.py`
