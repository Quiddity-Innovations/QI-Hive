...
| QI_TrinityCheck_Daily | daily 07:15 | `engine\tools\TrinityCheck_Daily.bat` | hidden_user | Added 2026-09-08. Trinity drift detector (inspection only, no assistant calls). Outcome check: marker `overall=PASS` in `LOGS\trinity_check.log` via task_health_manifest. |
