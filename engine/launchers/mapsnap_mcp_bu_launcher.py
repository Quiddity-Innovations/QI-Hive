...
Runs the SHIPPED gateway copy (C:\\APPS\\MapSnap\\tools\\qi_mcp_gateway.py — the one
...
sys.path.insert(0, r"C:\APPS\MapSnap\tools")
if hasattr(sys.stdout, "reconfigure"):
    sys.stdout.reconfigure(encoding="utf-8", errors="replace")

from qi_mcp_gateway import main  # noqa: E402

main(r"C:\APPS\MapSnap\config\mcp_gateway_bu.json")
