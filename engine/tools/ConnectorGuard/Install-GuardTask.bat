...
schtasks /Create /F /SC MINUTE /MO 5 /TN "QI_McpConnectorGuard" /TR "conhost --headless C:\1-AI\APPS\PYTHON\python.exe C:\QIH\engine\tools\ConnectorGuard\connector_guard.py"
