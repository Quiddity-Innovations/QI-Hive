...
PROJECTS = {
    ...
    "tubescout":    ("TubeScout",            Path(r"C:\APPS\TUBESCOUT\INTRO")),
    "cognibase":    ("CogniBase",            Path(r"C:\APPS\CogniBase\INTRO")),
    "personalsong": ("PersonalSong Studio",  Path(r"C:\APPS\PersonalSong\INTRO")),
    "avatarstudio": ("AvatarStudio",         Path(r"C:\APPS\AvatarStudio\INTRO")),
    "akiyascout":   ("AkiyaScout",           Path(r"C:\APPS\AkiyaScout\INTRO")),
    "lotterywiz":   ("LotteryWiz",           Path(r"C:\APPS\Lottery Wiz\INTRO")),
    "claude_voice": ("Claude Voice",         Path(r"C:\APPS\CLAUDE\Claude Voice\INTRO")),
    "claude_manager":("Claude Manager",      Path(r"C:\APPS\CLAUDE\INTRO")),
    "mq":           ("MQ",                   Path(r"C:\APPS\MQ\INTRO")),
    "m2v":          ("M2V",                  Path(r"C:\APPS\M2V\INTRO")),
    "gamez":        ("Gamez",                Path(r"C:\APPS\Gamez\INTRO")),
    "filehq":       ("FileHQ",               Path(r"C:\APPS\NAYA\filehq\INTRO")),
    "cypherminer":  ("CypherMiner",          Path(r"C:\APPS\CypherMiner\INTRO")),
    ...
    "bakeoff":      ("Bakeoff",      Path(r"C:\APPS\QIP\Bakeoff\INTRO")),
    "qi_connector": ("QI Connector", Path(r"C:\APPS\QIP\Connector\INTRO")),
}
